...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PendingReason)(nil), (*scheduling.PendingReason)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PendingReason_To_scheduling_PendingReason(a.(*PendingReason), b.(*scheduling.PendingReason), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.PendingReason)(nil), (*PendingReason)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_PendingReason_To_v1beta1_PendingReason(a.(*scheduling.PendingReason), b.(*PendingReason), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_PendingReason_To_scheduling_PendingReason(in *PendingReason, out *scheduling.PendingReason, s conversion.Scope) error {
	out.Action = in.Action
	out.Plugin = in.Plugin
	out.Reason = scheduling.Reason(in.Reason)
	out.Message = in.Message
	return nil
}

// Convert_v1beta1_PendingReason_To_scheduling_PendingReason is an autogenerated conversion function.
func Convert_v1beta1_PendingReason_To_scheduling_PendingReason(in *PendingReason, out *scheduling.PendingReason, s conversion.Scope) error {
	return autoConvert_v1beta1_PendingReason_To_scheduling_PendingReason(in, out, s)
}

func autoConvert_scheduling_PendingReason_To_v1beta1_PendingReason(in *scheduling.PendingReason, out *PendingReason, s conversion.Scope) error {
	out.Action = in.Action
	out.Plugin = in.Plugin
	out.Reason = Reason(in.Reason)
	out.Message = in.Message
	return nil
}

// Convert_scheduling_PendingReason_To_v1beta1_PendingReason is an autogenerated conversion function.
func Convert_scheduling_PendingReason_To_v1beta1_PendingReason(in *scheduling.PendingReason, out *PendingReason, s conversion.Scope) error {
	return autoConvert_scheduling_PendingReason_To_v1beta1_PendingReason(in, out, s)
}
...
func autoConvert_v1beta1_PodGroupStatus_To_scheduling_PodGroupStatus(in *PodGroupStatus, out *scheduling.PodGroupStatus, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_PendingReason_To_scheduling_PendingReason(&in.PendingReason, &out.PendingReason, s); err != nil {
		return err
	}
...
func autoConvert_scheduling_PodGroupStatus_To_v1beta1_PodGroupStatus(in *scheduling.PodGroupStatus, out *PodGroupStatus, s conversion.Scope) error {
	...
	if err := Convert_scheduling_PendingReason_To_v1beta1_PendingReason(&in.PendingReason, &out.PendingReason, s); err != nil {
		return err
	}
